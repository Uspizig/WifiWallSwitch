...
//does not work with S3 without modifications in C:\Users\uli\AppData\Local\Arduino15\packages\esp32\hardware\esp32\2.0.3-RC1\cores\esp32\esp32-hal-misc.c Line 71
/*******************************************************************
...
uint8_t int1Status = 0;//Interrupt variables
...
void setup_Gyro(void){
  if( myIMU.beginCore() != 0 )Serial.print("Error at beginCore().\n");
	else Serial.print("\nbeginCore() passed.\n");
